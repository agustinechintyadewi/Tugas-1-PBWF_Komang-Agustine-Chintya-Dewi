...
<body>
    ...
    <div class="dashboard-content">
            <?php $__currentLoopData = $hewan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hewan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <ul>
                <div class="dashboard-card">
                    <img src="image/cute-dog-house-waiting-be-adopted-by-someone.jpg" class="card-image">
                    <div class="card-detail">
                        <h4><?php echo e($hewan->nama); ?> (<?php echo e($hewan->umur); ?>)</h4>
                        <p> <?php echo e($hewan->jenis); ?></p>
                        <p><b>Kondisi:</b></p>
                        <p><?php echo e($hewan->kondisi); ?></p>
                        <p><b>Syarat Adopsi:</b></p>
                        <p><?php echo e($hewan->syarat); ?></p>
                    </div>
                    <div class="details">
...
</html><?php /**PATH D:\Chintya\KULIAH\SMT 6\PEMWEB\Project\petshelter\resources\views/hewan/listhewan.blade.php ENDPATH**/ ?>